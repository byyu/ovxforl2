...
public class SetFlowServiceSLA extends ApiHandler<Map<String, Object>>{
	Logger log = LogManager.getLogger(SetFlowServiceSLA.class.getName());
	...
	public JSONRPC2Response process(final Map<String, Object> params){
		...
		try {
			...
			slaHandler.setFlowServiceSLA(tenantId.intValue(), flowId, tcpPort1.intValue(), tcpPort2.intValue(), sla.intValue());
